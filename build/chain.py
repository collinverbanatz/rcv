...
class Chain:
    ...
    def bend_chain(self, bone, ctrl_scale, spans=16, mirror=False,
            ...
            mid_ctrl = nmCtrl.Control(parent=ctrl_grp,
                                    shape='circle',
                                    prefix=None,
                                    suffix='CTRL',
            ...
            s_tan = nmCtrl.Control(parent=ctrl_grp,
                                shape='square',
                                prefix=None,
                                suffix='CTRL',
            ...
            e_tan = nmCtrl.Control(parent=ctrl_grp,
                                shape='square',
                                prefix=None,
                                suffix='CTRL',
            ...
            curvature = nmAttr.Attribute(node=mid_ctrl.ctrl, type='double', value=1,
                                        min=0.001, max=3, keyable=True,
                                        name='curvature')
            tangent_vis = nmAttr.Attribute(node=mid_ctrl.ctrl, type='bool',
