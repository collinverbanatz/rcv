...
importlib.reload(nmFk)
importlib.reload(nmIk)

importlib.reload(nmChain)
    ...
    def output_rig(self):
        ...
        if self.create_fk and self.create_ik:
            blend_chain = nmChain.Chain(transform_list=self.src_joints,
                                        ...
                                        suffix='switch_JNT',
                                        name=self.part)
            blend_chain.create_blend_chain(switch_node=self.main_ctrl.ctrl,
